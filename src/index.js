...
const DEFAULT_WHEEL_PROFILES = {
    'Reward Wheel': {
        segments: [
            ...
            { trigger: '', text: 'Big Prize!', command: '/echo Amazing! You won the big prize!', size: 'halfseg', respin: false },
            { trigger: '', text: 'Try Again', command: '/echo Better luck next time...', size: 'fraction', respin: false },
            { trigger: '', text: 'JACKPOT!', command: '/echo JACKPOT! Incredible luck!', size: 'halfseg', respin: false },
    ...
    'Challenge Wheel': {
        segments: [
            ...
            { trigger: '', text: 'Free Pass', command: '/echo Lucky! You get a free pass!', size: 'halfseg', respin: false },
            { trigger: '', text: 'Double or Nothing', command: '/echo Spin again - double stakes!', size: 'fraction', respin: true },
        ],
        randomize: false,
        difficulty: 2,
    },
